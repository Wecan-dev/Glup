...
<?php $loop = new WP_Query( 'post_type=banner&categorias_banner=apps&posts_per_page=-1' ); ?>
  ...
  <section class="solutions-methodologies">
    <div class="title">
		 <h3>Soluciones en</h3>
      <h2>Nuestros Workshops</h2>
		   <div class="width-text">
      <p class="child-width"  >A través de nuestros workshops podrás conocer más sobre las múltiples posibilidades de herramientas que tienes disponible dentro de tu licenciamiento Microsoft. De forma práctica, abordaremos las problemáticas del negocio y construiremos conocimiento por medio de sesiones de trabajo divertidas y de gran valor para tu empresa.   </p>
			     </div>
    </div>
    <div class="container">
        ...
        <div class="solution-item">
          ...
          <div class="solution-item-text">
            <div class="solution-title custom-collapse">
              <h4><?php the_title(); ?></h4>
              <img class="custom-collapse arrow__visible" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/arrow_down.svg">
            </div>
        ...
        <div class="col-lg-6">
          <div class="process-text">
            <div class="side-title">
               <h3 ><?php the_title() ?></h3>
                <h2 style="color:#fff;"><?php the_field('procesos_subtitle'); ?></h2>
            </div>
            <p><?php the_content() ?></p>
            <a class="white-hiperlink" href='<?php bloginfo('url');?>/contacto'>
              Contáctanos
