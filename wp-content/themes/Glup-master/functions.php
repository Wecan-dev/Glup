...
function theme_customize_register($wp_customize){
    ...
    // texto de red
    $wp_customize->add_setting('texto', array(
      'default' => ''
    ));
...
if ( ! function_exists('servicios') ) {
    ...
    function servicios() {
        ...
        $labels = array(
            ...
            'menu_name'             => __( 'Servicios Inicio', 'text_domain' ),
            'name_admin_bar'        => __( 'Servicios Inicio', 'text_domain' ),
            'archives'              => __( 'Item Archives', 'text_domain' ),
            'attributes'            => __( 'Item Attributes', 'text_domain' ),
            'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
            'all_items'             => __( 'All Items', 'text_domain' ),
...
if ( ! function_exists('pagina_servicios') ) {
    ...
    add_action( 'init', 'pagina_servicios', 0 );
     ...
     // Register Custom Post Type
if ( ! function_exists('nuestros_servicios') ) {
  
    // Register Custom Post Type
    function nuestros_servicios() {
    
        $labels = array(
            'name'                  => _x( 'nuestros_servicios', 'Post Type General Name', 'text_domain' ),
            'singular_name'         => _x( 'nuestro_servicio', 'Post Type Singular Name', 'text_domain' ),
            'menu_name'             => __( 'Nuestros Servicios', 'text_domain' ),
            'name_admin_bar'        => __( 'Nuestros Servicios', 'text_domain' ),
            'archives'              => __( 'Item Archives', 'text_domain' ),
            'attributes'            => __( 'Item Attributes', 'text_domain' ),
            'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
            'all_items'             => __( 'All Items', 'text_domain' ),
        ...
        $args = array(
            'label'                 => __( 'nuestros_servicios', 'text_domain' ),
            'description'           => __( 'nuestros_servicios', 'text_domain' ),
            'labels'                => $labels,
            'supports'              => array( 'title', 'editor', 'thumbnail', 'custom-fields' ),
            'taxonomies'            => array( 'category', 'post_tag' ),
            'hierarchical'          => false,
...
if ( ! function_exists('pilares_soporte') ) {
    ...
    add_action( 'init', 'pilares_soporte', 0 );
       ...
       // Register Custom Post Type
if ( ! function_exists('soluciones_logos') ) {
  
    // Register Custom Post Type
    function soluciones_logos() {
    
        $labels = array(
            'name'                  => _x( 'Soluciones/Logos', 'Post Type General Name', 'text_domain' ),
            'singular_name'         => _x( 'Soluciones/Logos', 'Post Type Singular Name', 'text_domain' ),
            'menu_name'             => __( 'Soluciones/Logos', 'text_domain' ),
            'name_admin_bar'        => __( 'Soluciones/Logos', 'text_domain' ),
            'archives'              => __( 'Item Archives', 'text_domain' ),
            'attributes'            => __( 'Item Attributes', 'text_domain' ),
            'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
            'all_items'             => __( 'All Items', 'text_domain' ),
        ...
        $args = array(
            'label'                 => __( 'soluciones_logos', 'text_domain' ),
            'description'           => __( 'soluciones_logos', 'text_domain' ),
            'labels'                => $labels,
            'supports'              => array( 'title', 'editor', 'thumbnail', 'custom-fields' ),
            'taxonomies'            => array( 'category', 'post_tag' ),
            'hierarchical'          => false,
        ...
        register_post_type( 'soluciones_logos', $args );
    
    }
    add_action( 'init', 'soluciones_logos', 0 );
